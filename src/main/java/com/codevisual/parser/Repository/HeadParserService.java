 ...
 */
@Service
public class HeadParserService {

    Repository repository ;

    public  List<RevCommit> getCommits(Repository repository) {
    ...
    public  void parseCompilationUnit(final File sourceFile)
     ...
     */
    public  List<CompilationUnit> getJavaCompilationUnit(final RevCommit c,Repository repository)
